...
$sql = "INSERT INTO stu_profile (name, dept, batch, year, semester, email, mno) VALUES ('$name','$dept','$batch','$year','$semester','$email','$mno')";
if(mysqli_query($link, $sql)){
    echo "Records added successfully.";
	header('Location:http://localhost/ALAID/SdetailView.php');
} else{
